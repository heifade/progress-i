...
export function ff(stream: NodeJS.WriteStream) {
  ...
  var prevLineCount = 0;
  var log: any = function(pars: string) {
    str = "";
...
export const stdout = ff(process.stdout);
export const stderr = ff(process.stderr);
